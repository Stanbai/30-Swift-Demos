...
class FeedParser: NSObject, XMLParserDelegate {
  ...
  fileprivate var parserCompletionHandler: (([(title: String, publishDate: String, description: String)]) -> Void)?
  
    func parseFeed(feedURL: String, completionHandler: (( [(title: String, publishDate: String, description: String)] ) -> Void)?) -> Void {
  ...
  func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
    if elementName == "item" {
        let rssItem = (title: currentTitle, publishDate: currentPubDate, description: currentDescription)
